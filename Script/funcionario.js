...
window.onload = function () {
    try {
       $.ajax({
		url: "http://stella.elementfx.com/funcionario.php",
	    type: "POST",
	    dataType: "json"
...
function Excluir(botao){
    ...
    try {
        $.ajax({
            url: "http://stella.elementfx.com/Excluir.php",
            type: "POST",
...
async function salvarEdicao(id) {
    ...
    try {
        const response = await fetch('http://stella.elementfx.com/editarFuncionario.php', {
            method: 'POST',
