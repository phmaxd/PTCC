...
window.onload = function () {
    try {
       $.ajax({
		url: "http://ptcc.elementfx.com/funcionario.php",
	    type: "POST",
	    dataType: "json"
...
function Excluir(botao){
    ...
    try {
        $.ajax({
            url: "http://ptcc.elementfx.com/Excluir.php",
            type: "POST",
...
modal.innerHTML = `
  ...
  ">
    ...
    <input type="text" id="editNome" value="${nome}" maxlength="11" minlength="11" style="
      width: 80%;
      padding-left: 16px;
margin-left: 16px;
      padding: 8px 10px;
...
async function salvarEdicao(id) {
    ...
    try {
        const response = await fetch('http://ptcc.elementfx.com/editarFuncionario.php', {
            method: 'POST',
